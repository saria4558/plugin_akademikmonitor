...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $data = $existing ?: new stdClass();
    $data->id_kurikulum_jurusan = $kurjur->id;
    $data->id_mapel = $mapelid;
    $data->tingkat_kelas = $tingkat;
    $data->jam_pelajaran = $jam;
    $data->kktp = $kktp;

    if ($existing) {
        $DB->update_record('kurikulum_mapel', $data);
        $msg = 'Mapel jurusan berhasil diperbarui.';
    } else {
        $DB->insert_record('kurikulum_mapel', $data);
